...
class Services {
   ...
   */
  getUser(opneId) {
    return axios.get(`${baseUrl}/api/getUser?opneId=${opneId}`)
  }
  ...
  povCharacters (limit = 20) {
    return axios.get(`${baseUrl}/api/characters?limit=${limit}`)
  }
   ...
   */
  focusHouse (id) {
    return axios.get(`${baseUrl}/api/houses/${id}`)
  }
   ...
   */
  focusCharacter (id) {
    return axios.get(`${baseUrl}/api/characters/${id}`)
  }
